# Operator Quickstart — Funeral and related activities

Shortest path from clone to a verified local dry-run for **ISIC 9603** (`cloud-itonami-isic-9603`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9603.git
cd cloud-itonami-isic-9603
```
...
- Blueprint governor key: `funeral-services-governor`
- Likely source path: `funeral.governor.cljc`
